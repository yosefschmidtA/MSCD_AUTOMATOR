...
echo "Installing Fortran, MPI, Python data libraries, and 32-bit libraries..."
# 'glibc-32bit' is the 32-bit C library (our libc6:i386 equivalent)
sudo zypper install -y gcc-fortran openmpi-devel python3-numpy python3-pandas python3-matplotlib python3-scipy glibc-32bit
